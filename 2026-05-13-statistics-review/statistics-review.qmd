...
subtitle: "Proportions of successes, binomials, and evidence to reject the null train-of-thought"
...
knitr::opts_chunk$set(echo = TRUE, dev = "ragg_png", dpi = 300, fig.width = 8, warning = F, message = F, echo = T)
...
dolphin_data |> 
  ...
  geom_stack() + 
  geom_stack_label() + 
  # New! using a text annotation layer
  annotate(geom = "text",  
           x = I(.2),
           y = I(.75),
           label = "🐬🐬🐟🪣",
