...
Some data cleaning has been done for you in the code below - from an html table (data in the wild). Check out the walk through [here](https://evamaerey.github.io/little_flipbooks_library/data_cleaning/data_cleaning#17):
